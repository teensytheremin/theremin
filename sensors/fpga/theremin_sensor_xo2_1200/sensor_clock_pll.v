...
/* Module Version: 5.7 */
/* C:\Tools\lscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n sensor_clock_pll -lang verilog -synth lse -arch xo2c00 -type pll -fin 12.288 -fclkop 393.216 -fclkop_tol 0.0 -fclkos 196.608 -fclkos_tol 0.0 -fclkos2 98.304 -fclkos2_tol 0.0 -trimp 0 -phasep 0 -trimp_r -trims 0 -phases 0 -trims_r -phases2 0 -phase_cntl STATIC -fb_mode 1 -lock  */
/* Mon Nov 22 18:28:40 2021 */


`timescale 1 ns / 1 ps
module sensor_clock_pll (CLKI, CLKOP, CLKOS, CLKOS2, LOCK)/* synthesis NGD_DRC_MASK=1 */;
		input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    output wire CLKOS2;
    ...
    defparam PLLInst_0.CLKFB_DIV = 32 ;
    ...
    EHXPLLJ PLLInst_0 (.CLKI(CLKI), .CLKFB(CLKOP_t), .PHASESEL1(scuba_vlo), 
        ...
        .PLLDATO2(), .PLLDATO1(), .PLLDATO0())
             /* synthesis FREQUENCY_PIN_CLKOS2="98.304000" */
             /* synthesis FREQUENCY_PIN_CLKOS="196.608000" */
             /* synthesis FREQUENCY_PIN_CLKOP="393.216000" */
             /* synthesis FREQUENCY_PIN_CLKI="12.288000" */
    ...
    // exemplar begin
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS2 98.304000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOS 196.608000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKOP 393.216000
    // exemplar attribute PLLInst_0 FREQUENCY_PIN_CLKI 12.288000
