...
module cabinet_face_flat(cabinet_length=400, cabinet_width=63, cabinet_height=40, sheet_thickness=5, edge_extra=5, edge_rounding=3, ray_correction=0.1, panel_width=120, panel_height=18, panel_rounding=8, panel_offset_y = 0, spike_width = 20, spike_height = 9) {
    ...
    difference() {
        union() {
            difference() {
                ...
                translate([0,panel_offset_y,0]) rounded_rectangle(panel_width, panel_height, panel_rounding);
...
module cabinet_front(cabinet_length=400, cabinet_width=63, cabinet_height=40, sheet_thickness=5, edge_extra=5, edge_rounding=4, ray_correction=0.1, panel_width=120, panel_height=18, panel_rounding=8, panel_offset_y = 0, spike_width = 20, spike_height = 9) {
    translate([0,0,-sheet_thickness/2]) linear_extrude(sheet_thickness)
        cabinet_face_flat(cabinet_length=cabinet_length, cabinet_width=cabinet_width, cabinet_height=cabinet_height, sheet_thickness=sheet_thickness, edge_extra=edge_extra, edge_rounding=edge_rounding, ray_correction=ray_correction, panel_width=panel_width, panel_height=panel_height, panel_rounding=panel_rounding, panel_offset_y = panel_offset_y, spike_width=spike_width, spike_height=spike_height);
}

module cabinet_back(cabinet_length=400, cabinet_width=63, cabinet_height=40, sheet_thickness=5, edge_extra=5, edge_rounding=4, ray_correction=0.1, panel_width=120, panel_height=18, panel_rounding=8, panel_offset_y = 0, spike_width = 20, spike_height = 9) {
    translate([0,0,-sheet_thickness/2]) linear_extrude(sheet_thickness)
        cabinet_face_flat(cabinet_length=cabinet_length, cabinet_width=cabinet_width, cabinet_height=cabinet_height, sheet_thickness=sheet_thickness, edge_extra=edge_extra, edge_rounding=edge_rounding, ray_correction=ray_correction, panel_width=panel_width, panel_height=panel_height, panel_rounding=panel_rounding, panel_offset_y = panel_offset_y, spike_width=spike_width, spike_height=spike_height);
}
...
//cabinet_front(ray_correction=-1);
