...
module cabinet_tablet_mount_flat(cabinet_length=400, cabinet_width=63, cabinet_height=40, sheet_thickness=5, edge_extra=5, edge_rounding=3, ray_correction=0.1, angle=60) {
    ...
    holder_tip_length = 10+edge_rounding*2;
...
module cabinet_tablet_mount(cabinet_length=400, cabinet_width=63, cabinet_height=40, sheet_thickness=5, edge_extra=5, edge_rounding=3, ray_correction=0.1, angle=60) {
