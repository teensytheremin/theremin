...
module cabinet_top_flat(cabinet_length=400, cabinet_width=63, cabinet_height=40, sheet_thickness=5, edge_extra=5, edge_rounding=3, ray_correction=0.1, spike_width = 20, spike_height = 9) {
    ...
    difference() {
        ...
        // center holes for tablet holder
        translate([-tablet_mount_offset, 0, 0]) square([sheet_thickness-ray_correction*2, spike_width-ray_correction*2], center=true);
        translate([tablet_mount_offset, 0, 0]) square([sheet_thickness-ray_correction*2, spike_width-ray_correction*2], center=true);
...
module cabinet_top(cabinet_length=400, cabinet_width=63, cabinet_height=40, sheet_thickness=5, edge_extra=5, edge_rounding=4, ray_correction=0.1, spike_width = 20, spike_height = 9) {
    translate([0,0,-sheet_thickness/2]) linear_extrude(sheet_thickness)
        cabinet_top_flat(cabinet_length=cabinet_length, cabinet_width=cabinet_width, cabinet_height=cabinet_height, sheet_thickness=sheet_thickness, edge_extra=edge_extra, edge_rounding=edge_rounding, ray_correction=ray_correction, spike_width=spike_width, spike_height=spike_height);
}
